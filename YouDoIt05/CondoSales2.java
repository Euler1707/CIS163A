 ...
 // Section 14887
 // HW 5 Problem 3(B) MODIFIED
 // Filename: CONDOSALES2.java 
...
public class CondoSales2
{
   ...
   selection = keyboard.nextInt();
      ...
      if(selection == 1) // Park View 37-497
      {
         ...
         if(kitchenCover == 1) // Park View // Kitchen Cover
         {   
            ...
            if(garage == 1) // Park View // Kitchen Cover // Garage
            {   
               garageCost = 5000.00; 
               ...
               if(expedite == 1) // Park View // Kitchen Cover // Garage // Expedite
               {
               ...
               else if(expedite ==2) // Park View // Kitchen Cover // Garage // NO Expedite
               {
                  expediteCost = 0;
               ...
               else  // Park View // Kitchen Cover // Garage // NO Expedite
               {
                  expediteCost = 0;
            ...
            else if(garage == 2) // Park View // Kitchen Cover // NO Garage             
            {  
               garageCost = 0;
              ...
              System.out.println("Press 1 if construction needs to be expedited.\n"+
               ...
               if(expedite == 1) // Park View // Kitchen Cover // NO Garage // Expedite
               {
                  expediteCost = 2000.00;
               ...
               else if(expedite ==2)//Park View// Kitchen Cover // NO Garage //NO Expedite
               {
                  expediteCost = 0;
               ...
               else //Park View// Kitchen Cover // NO Garage //NO Expedite
               {
                  expediteCost = 0;
            ...
            else //Park View// Kitchen Cover // NO Garage
               {
         ...
         else if(kitchenCover == 2) //Park view// No Kitchen Cover // 
         {   
            kitchenCoverCost = 0;
            ...
            if(garage == 1) // Park View // No Kitchen Cover // Garage
            {   
               garageCost = 5000.00; 
               ...
               if(expedite == 1) // Park View // No Kitchen Cover // Garage // Expedite
               {
                  expediteCost = 2000.00;
               ...
               else if(expedite ==2) // Park View //No Kitchen Cover // Garage // NO Expedite
               {
                  expediteCost = 0;
               ...
               else  // Park View // No Kitchen Cover // Garage // NO Expedite
               {
                  expediteCost = 0;
            ...
            else if(garage == 2) // Park View // No Kitchen Cover // NO Garage             
            {  
               garageCost = 0;
              ...
              System.out.println("Press 1 if construction needs to be expedited.\n"+
               ...
               if(expedite == 1) // Park View // No Kitchen Cover // NO Garage // Expedite
               {
                  expediteCost = 2000.00;
               ...
               else if(expedite ==2)//Park View// No Kitchen Cover // NO Garage //NO Expedite
               {
                  expediteCost = 0;
               ...
               else //Park View// No Kitchen Cover // NO Garage //NO Expedite
               {
                  expediteCost = 0;
...
//            
            ...
            else //Park View// No Kitchen Cover // NO Garage
               {
      ...
      else if(selection == 2)//Section2 
      {
         ...
         if(kitchenCover == 1) // Golf  Course View // Kitchen Cover
         {   
            kitchenCoverCost = 4000.00;
            ...
            if(garage == 1) // Golf  Course View // Kitchen Cover // Garage
            {   
               garageCost = 5000.00; 
               ...
               if(expedite == 1) // Golf  Course View // Kitchen Cover // Garage // Expedite
               {
                  expediteCost = 2000.00;
               ...
               else if(expedite ==2) // Golf  Course View // Kitchen Cover // Garage // NO Expedite
               {
                  expediteCost = 0;
               ...
               else  // Golf  Course View // Kitchen Cover // Garage // NO Expedite
               {
                  expediteCost = 0;
            ...
            else if(garage == 2) // Golf  Course View // Kitchen Cover // NO Garage             
            {  
               garageCost = 0;
              ...
              System.out.println("Press 1 if construction needs to be expedited.\n"+
               ...
               if(expedite == 1) // Golf  Course View // Kitchen Cover // NO Garage // Expedite
               {
                  expediteCost = 2000.00;
               ...
               else if(expedite ==2)//Golf  Course View// Kitchen Cover // NO Garage //NO Expedite
               {
                  expediteCost = 0;
               ...
               else //Golf  Course View// Kitchen Cover // NO Garage //NO Expedite
               {
                  expediteCost = 0;
            ...
            else //Golf  Course View// Kitchen Cover // NO Garage
               {
         ...
         else if(kitchenCover == 2) //Golf  Course view// No Kitchen Cover // 
         {   
            kitchenCoverCost = 0;
            ...
            if(garage == 1) // Golf  Course View // No Kitchen Cover // Garage
            {   
               garageCost = 5000.00; 
               ...
               if(expedite == 1) // Golf  Course View // No Kitchen Cover // Garage // Expedite
               {
                  expediteCost = 2000.00;
               ...
               else if(expedite ==2) // Golf  Course View //No Kitchen Cover // Garage // NO Expedite
               {
                  expediteCost = 0;
               ...
               else  // Golf  Course View // No Kitchen Cover // Garage // NO Expedite
               {
                  expediteCost = 0;
            ...
            else if(garage == 2) // Golf  Course View // No Kitchen Cover // NO Garage             
            {  
               garageCost = 0;
              ...
              System.out.println("Press 1 if construction needs to be expedited.\n"+
               ...
               if(expedite == 1) // Golf  Course View // No Kitchen Cover // NO Garage // Expedite
               {
                  expediteCost = 2000.00;
               ...
               else if(expedite ==2)//Golf  Course View// No Kitchen Cover // NO Garage //NO Expedite
               {
                  expediteCost = 0;
               ...
               else //Golf  Course View// No Kitchen Cover // NO Garage //NO Expedite
               {
                  expediteCost = 0;
...
//            
            ...
            else //Golf  Course View// No Kitchen Cover // NO Garage
               {
